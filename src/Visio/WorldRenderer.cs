...
using Visio.Renderer.Lights;
using NLog;
using Visio.Components;
using Visio.Systems;
using Camera3D = Visio.Components.Camera3D;
using DirectionalLight = Visio.Renderer.Lights.DirectionalLight;
using PointLight = Visio.Renderer.Lights.PointLight;
using SpotLight = Visio.Renderer.Lights.SpotLight;

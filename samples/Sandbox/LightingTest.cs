...
public static class LightingTest {
	...
	public static void Start(string[] args) {
		...
		e01.GetChild(index: 0).Get<Renderable>().Model.Meshes[0].Material.HeightTexture = ResourceManager.Load<TextureResource>(platform, "/textures/Bricks059_1K-JPG/Bricks059_1K-JPG_Displacement.jpg");
		...
		e02.GetChild(index: 0).Get<Renderable>().Model.Meshes[0].Material.HeightTexture = ResourceManager.Load<TextureResource>(platform, "/textures/Concrete041B_1K-JPG_Displacement.jpg");

...
namespace Eclair.Renderer.Vulkan {

	public unsafe class VulkanDevice : IDevice {
		...
		public VulkanDevice(VulkanPlatform platform, PhysicalDevice nativeDevice, IList<string>? extensions = null) {
			extensions ??= [];

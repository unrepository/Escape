...
namespace GENESIS.PresentationFramework.Drawing {
	...
	public static class Models {
		...
		public static readonly Vertex[] Cube = [
		    new() { Position = new(-1.0f, -1.0f,  1.0f), TexCoords = new(0.0f, 0.0f) },
		    new() { Position = new(-1.0f,  1.0f,  1.0f), TexCoords = new(0.0f, 1.0f) },
		    new() { Position = new( 1.0f,  1.0f,  1.0f), TexCoords = new(1.0f, 1.0f) },
		    new() { Position = new(-1.0f, -1.0f,  1.0f), TexCoords = new(0.0f, 0.0f) },
		    new() { Position = new( 1.0f,  1.0f,  1.0f), TexCoords = new(1.0f, 1.0f) },
		    new() { Position = new( 1.0f, -1.0f,  1.0f), TexCoords = new(1.0f, 0.0f) },
		    new() { Position = new(-1.0f, -1.0f, -1.0f), TexCoords = new(1.0f, 0.0f) },
		    new() { Position = new( 1.0f,  1.0f, -1.0f), TexCoords = new(0.0f, 1.0f) },
		    new() { Position = new(-1.0f,  1.0f, -1.0f), TexCoords = new(1.0f, 1.0f) },
		    new() { Position = new(-1.0f, -1.0f, -1.0f), TexCoords = new(1.0f, 0.0f) },
